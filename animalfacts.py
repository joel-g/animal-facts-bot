...
def check_comment_for_animal(comment, reddit):
    ...
    botengine('tarsier', '\starsier?\s', reddit, TARSIER_FACTS, comment)
...
TARSIER_FACTS = (
    ...
    'Their large eyes enables them to have acute night vision that makes them a good hunter.',
    'Their long feet enables them to jump from tree to tree up to 3 meters in distance.',
