...
WHALE_FACTS = (
    ...
    'Various scientific studies have calculated life expectancy averages of various species to range anywhere from 30 – 70 years all the way up to 200 years.',
    'Blue Whales mainly catch their food by diving, and descend to depths of approximately 500m.',
